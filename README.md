...
`pnpm dev` 会启动 React playground，`pnpm dev:vue` 会启动 Vue playground。两个 playground 都包含四个页面：

| 页面 | 内容 |
|---|---|
| 总览 | 完整 Assistant 示例，包含消息、streaming、error、工具调用、引用、附件、推理和输入区 |
| react-ui / vue-ui | Button、Input、Textarea、Card、Badge、Dialog、Tabs、Empty 全量展示 |
| react-ai / vue-ai | Attachments、ToolCallCard、CitationList、ReasoningBlock、TaskTimeline、Composer、MessageList 展示 |
